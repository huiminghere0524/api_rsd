...
import my.edu.tarc.api_rsd.api.RetrofitInstance
            ...
            call.enqueue(object : Callback<List<StudentRespond>>{
                override fun onResponse(
                    ...
                    for(student : StudentRespond in rs!!){
                        ...
                        name += "ID : ${student.id} Name : ${student.name}\n"

                    }

                    findViewById<TextView>(R.id.tvResult).text = name
